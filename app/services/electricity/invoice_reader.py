...
def save_invoice_after_verification(
    ...
    invoice = ElectricityInvoice(
        ...
        usage_kwh=round(invoice_data['usage_kwh'], 2),
        energy_price_net=round(invoice_data['energy_price_net'], 4),
        energy_value_net=round(invoice_data['energy_value_net'], 2),
        energy_vat_amount=round(invoice_data['energy_vat_amount'], 2),
        energy_value_gross=round(invoice_data['energy_value_gross'], 2),
        distribution_fees_net=round(invoice_data['distribution_fees_net'], 2),
        distribution_fees_vat=round(invoice_data['distribution_fees_vat'], 2),
        distribution_fees_gross=round(invoice_data['distribution_fees_gross'], 2),
        vat_rate=invoice_data['vat_rate'],
        vat_amount=round(invoice_data['vat_amount'], 2),
        total_net_sum=round(invoice_data['total_net_sum'], 2),
        total_gross_sum=round(invoice_data['total_gross_sum'], 2),
        amount_to_pay=round(invoice_data['amount_to_pay'], 2),
